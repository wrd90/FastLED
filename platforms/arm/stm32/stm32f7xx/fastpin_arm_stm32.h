#ifndef __FASTPIN_ARM_STM32F7XX_H
#define __FASTPIN_ARM_STM32F7XX_H
...
//    if(_BIT<8)
//    {
//    	_GPIO::r() = (_GPIO::r() & (0xF << (_BIT*4))) | (0x1 << (_BIT*4));
//    } else {
//    	_GPIO::r() = (_GPIO::r() & (0xF << ((_BIT-8)*4))) | (0x1 << ((_BIT-8)*4));
//    }
//  }
...
_IO32(A); _IO32(B); _IO32(C); _IO32(D); _IO32(E); _IO32(F); _IO32(G); _IO32(H); _IO32(I); _IO32(J); _IO32(K);
// GPIO PORT C, GPIO PIN 8, BIT 0
_DEFPIN_ARM(40, 8, C);
#define HAS_HARDWARE_PIN_SUPPORT
#endif
